    ...
    <div class="card shadow">
      ...
      <div class="card-body p-4">
        <form action="/post/{{ $post->id }}" method="POST" enctype="multipart/form-data">
          ...
          @method('PUT')
          <div class="my-2">
            <a class="btn btn-dark" href="{{ route('frontend.post.index') }}">
              Back
            </a>
          </div>
          <hr>
          ...
          <div class="my-2">
            ...
            <!-- <input type="text" name="employee" id="employee" class="form-control" placeholder="Employee Name" value="{{ $post->employee }}" required> -->
            <select name="passport_type" id="passport_type" class="form-control" aria-lable=".form-select-lg example" value="{{ $post->passport_type }}">
