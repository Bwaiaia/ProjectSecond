        ...
        <div class="card shadow" >
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a class="btn btn-outline-dark my-2 my-sm-0" href="{{route('admin.post.edit', $post)}}">Edit Passport</a> 
                </div>
            </div>
            <div class="card-body p-4">
                <form class="text-center">
                    ...
                    <div class="box-footer text-left">
                        <a class="btn btn-outline-danger my-2 my-sm-0" href="{{ route('admin.post.index') }}">
